...
def check_gpu_status():
    """Check if CUDA is available - Force CPU for free hosting"""
    # Force CPU for free hosting platforms that don't support GPU
    return "cpu"
...
def transcribe_audio(task_id, filename, model_name, device, output_dir):
    ...
    try:
        ...
        transcription_status[task_id]["progress"] = "Running Whisper transcription..."
...
if __name__ == '__main__':
    print("Starting Whisper Web Transcriber...")
    print(f"GPU Status: {check_gpu_status()}")
